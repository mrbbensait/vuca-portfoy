        ...
        <div className="relative px-6 py-6 sm:px-8 sm:py-7">
          ...
          <div className="mt-6 pt-5 border-t border-white/10">
            {summaryLoading ? (
              ...
              <div className="flex items-center gap-3">
                <Wallet className="w-5 h-5 text-blue-300/50" />
                <div>
                  <p className="text-sm text-blue-200/70">Henüz portföyünüzde varlık bulunmuyor.</p>
                  <p className="text-xs text-blue-200/40 mt-0.5">Varlık ekleyerek portföy özetinizi görüntüleyebilirsiniz.</p>
                </div>
              </div>
            )}
          </div>
